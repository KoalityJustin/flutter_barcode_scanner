...
public class FlutterBarcodeScannerPlugin implements MethodCallHandler, ActivityResultListener, StreamHandler, FlutterPlugin, ActivityAware {
    ...
    // Changed from FlutterActivity to Activity since with Android embedding v2 the root app could be
    // a FragmentActivity or a FlutterFragmentActivity. So instead of tying it to one type we can
    // use the basic Activity type which is a super for both.
